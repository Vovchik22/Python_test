...
class Engine (object):
    ...
    def play (self):
        ...
        last_scene = self.scene_map.next_scene_map('finished')

        while current_scene != last_scene:
            next_scene_name = current_scene.enter()
            current_scene = self.scene_map.next_scene(next_scene)
            #be sure to print out the last scene
        current_scene.enter(1)
...
class LaserWeapon(Scene):
    ...
    def enter(self):
        ...
        if guess == code:
            ...
            Gothons blow up the ship from their shipself.
            '''))
            return 'death'
...
class TheBridge (Scene):
    ...
    def enter (self):
        ...
        if action == "throw_the_bomb":
            ...
            you run to the escape pod to get off this tin ca
            '''))
            return 'escape_pod'
...
class Map (object):
    """docstring for [object Object]."""
    scenes  = {
    'central_corridor': CentralCorriidor(),
